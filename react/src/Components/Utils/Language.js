export default {
    types: {
        ...
        task: {
            'again_at': 'Re-schedule a task at a specific date/time.',
            'again_in': 'Re-schedule a task relative to the original start time.',
            'args': 'Get a new list with then task arguments.',
            'at': 'Get the task scheduled date/time.',
            'cancel': 'Cancel a task.',
            'closure': 'Return the closure of the task.',
            'del': 'Delete a task.',
            'err': 'Get the task error (if any).',
            'id': 'Return id of the task or nil when the task is removed.',
            'owner': 'Return the owner name of the task.',
            'set_args': 'Set task arguments.',
            'set_closure': 'Set a new closure (code to execute) for an existing task.',
            'set_owner': 'Change the owner of a task.',
        },
        thing: {
    ...
    collection: {
        ...
        'export': 'This function can be used to export the collection structure as a readable string with ThingsDB code. The function is also capable of exporting the full collection. This full collection export is returned as bytes which then can be imported in a new collection using the import(..) function.',
        ...
        'import': 'This function can be used to import a collection which was exported using the export(..) function with the option dump enabled.',
        ...
        'is_email': 'This function determines whether the provided value is of type str and contains an email address.',
        ...
        'is_tel': 'is function determines whether the provided value is of type str and contains a telephone number.',
        ...
        'is_url': 'This function determines whether the provided value is of type str and contains a URL. A valid URL must start with either http:/// , https:// or ftp://.',
        ...
        'root': 'Returns the root for the current collection or nil when the current scope is not a collection scope.',
        ...
        'task': 'Create a new task or get an existing task by Id.',
        'tasks': 'Return a list with all the tasks in the current scope.',
        ...
        'timeit': 'The timeit function can be used to check the duration of some code. It only measures the execution time of the code and does not include additional change creation and does not wait for futures to be completed.',
        ...
        'ceil': 'Return the ceiling of a given number. This is the smallest integer >= the given number.',
        'cos': 'Return the cosine of a given number. The value passed in this function should be in radians.',
        'exp': 'Returns e raised to the power of x.',
        'floor': 'Return the floor of a given number. This is the largest integer <= the given number.',
        'log10': 'Return the base 10 logarithm of a given number.',
        'log2': 'Return the base 2 logarithm of a given number.',
        'loge': 'Returns the natural logarithm (base e) of a given number.',
        'pow': 'Returns x to the power of y.',
        'round': 'Return a number that will be rounded to the decimal places which are given as input.',
        'sin': 'Return the sine of a given number. The value passed in this function should be in radians',
        'sqrt': 'Return the square root of a given number.',
        'tan': 'Return the tangent of a given number. The value passed in this function should be in radians.',
    },
    errors: {
    ...
    procedures: {
        ...
        'procedures_info': 'Returns procedure information for all procedures in the scope.',
