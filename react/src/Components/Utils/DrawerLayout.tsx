...
const Main = styled('main', {shouldForwardProp: (prop: string) => !['open', 'menuOpen', 'newWidth', 'menuWidth', 'isResizing'].includes(prop)})(
...
const StyledDrawer = styled(Card, {shouldForwardProp: (prop) => prop !== 'open' && prop !== 'newWidth'})<StyledDrawerProps>(
    ({ theme, open, newWidth }) => ({
        marginRight: '0px',
        width: 0,
        height: '100%',
...
const Menu = styled(Drawer, {shouldForwardProp: (prop) => prop !== 'menuWidth'})<MenuProps>(
