...
const Arrow = ({startPointX, startPointY, endPointX, endPointY}) => {
    ...
    return(
        <React.Fragment>
            ...
            <polyline className="path" points={`${startPointX},${startPointY} ${endPointX},${endPointY}`} fill="none" stroke="#1d2c42" markerEnd="url(#arrow)" strokeWidth={3} strokeLinecap="round" />
